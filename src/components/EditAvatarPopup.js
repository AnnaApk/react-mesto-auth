...
function EditAvatarPopup(props) {
  ...
  return (
    <PopupWithForm name="edit-avatar" title="Обновить аватар" isOpen={props.isOpen} onClose={props.onClose} onSubmit={handleSubmit}>
      <input ref={avatarRef} id="new-avatar-input" className="popup__input popup__input_type_avatar" type="url" name="newAvatar" placeholder="Ссылка на картинку" required />
